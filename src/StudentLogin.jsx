...
export default function StudentLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Query Supabase for student with matching credentials
      ...
      if (error || !data) {
        alert("Invalid credentials! Please check your student number, email, and access code.");
        setLoading(false);
        return;
      }
      ...
      // Navigate to informed consent page
        ...
        <div className="w-full max-w-md">
          ...
          <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-red-700 hover:bg-red-600 text-white font-semibold py-2 px-4 text-sm rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
