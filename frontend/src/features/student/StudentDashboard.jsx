    ...
    >
      ...
      >
        ...
        <div className="p-4 flex-1">
          <p className="text-xs uppercase tracking-widest mb-3" style={{ color: theme.textMuted }}>Quick Tips</p>
          <div className="space-y-2 text-xs leading-relaxed" style={{ color: theme.textSecondary }}>
